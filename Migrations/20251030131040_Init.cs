    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "PostId", "AuthorId", "CreatedAt", "Title", "UpdatedAt", "UserId" },
                values: new object[] { 1, 1, new DateTime(2025, 10, 28, 22, 32, 0, 0, DateTimeKind.Utc), "Introduction to ASP.NET MVC", new DateTime(2025, 10, 28, 22, 32, 0, 0, DateTimeKind.Utc), null });
